...
public class ChanceCardManager {
    ...
    public static ChanceCard[] cardArrayInit(Tile[] tiles, Player[] players, Player currentPlayer, GUI gui) throws IOException {
        ...
        chanceCards[1] = new moveMoneyCard(stringList.get("ChanceCard2"), tiles, players, currentPlayer, gui, 2, 0, true);
        ...
        chanceCards[6] = new moveMoneyCard(stringList.get("ChanceCard7"), tiles, players, currentPlayer, gui, -2, 0, false);
        ...
        chanceCards[10] = new moveMoneyCard(stringList.get("ChanceCard11"), tiles, players, currentPlayer, gui, 0, 23, true);
        ...
        chanceCards[15] = new moveMoneyCard(stringList.get("ChanceCard16"), tiles, players, currentPlayer, gui, 2, 0, false);
        chanceCards[16] = new ColorCard(stringList.get("ChanceCard17"), tiles, players, currentPlayer, gui, 5, stringList.get("ColorRed"));
